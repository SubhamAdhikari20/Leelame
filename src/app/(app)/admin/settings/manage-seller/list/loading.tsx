// src/app/(app)/admin/settings/manage-seller/list/loading.tsx
                    ...
                    <TableBody>
                        {Array.from({ length: 6 }).map((_, idx) => (
                            <TableRow key={idx} className="even:bg-gray-50 dark:even:bg-gray-900">
                                ...
                                <TableCell className="p-3"><Skeleton className="h-10 w-10 rounded-full" /></TableCell>
                                ...
                                <TableCell className="p-3"><Skeleton className="h-8 w-24" /></TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
