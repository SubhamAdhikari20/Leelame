// src/app/api/users/buyer/update-profile-details/[id]/route.ts
...
export const PUT = async (req: NextRequest, context: { params: { id: string } }) => {
    try {
        ...
        return await buyerController.updateBuyerProfileDetails(req, context);
    }
    catch (error: Error | any) {
        console.error("Error updating buyer details in route:", error);
