// src/app/api/users/buyer/upload-profile-picture/[id]/route.ts
...
export const PUT = async (req: NextRequest, context: { params: { id: string } }) => {
    try {
        ...
        return await buyerController.uploadProfilePicture(req, context);
    }
    catch (error: Error | any) {
        console.error("Error uploading buyer profile picture in route:", error);
