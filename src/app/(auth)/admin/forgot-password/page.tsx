// src/app/(auth)/admin/forgot-password/page.tsx
"use client";
...
const ForgotPassword = () => {
    ...
    const onSubmit = async (data: z.infer<typeof forgotPasswordSchema>) => {
        ...
        try {
            const response = await axios.put<AdminResponseDtoType>("/api/users/admin/forgot-password", {
                email: data.email,
            });
            ...
            router.replace(`/admin/verify-account/reset-password?email=${data.email}`);
        }
        catch (error) {
